...
The qualified support range is source-built v0.4.3 ordinary billing schema 8 to the M2 implementation at commit `685ea0aa1f5f5a79042802bfc2d9ccfb1aa2d00f`. The exact fixture, unsupported old-writer refusal, row/receipt/alias/permission reconciliation, rollback and whole-installation backup-recovery evidence are recorded in [M2 migration qualification](m2-migration-qualification.md). This result does not qualify another source version, native archive, host, or historical billing store. See the [canonical billing roadmap](billing-roadmap.md) and [M2 implementation design](m2-implementation-design.md).
