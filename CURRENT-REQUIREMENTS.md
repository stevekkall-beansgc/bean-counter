...
| Native evidence | Tested macOS 26.6.2 on Apple silicon and Ubuntu 24.04.5 x86-64/glibc 2.39. Other OS versions and Linux distributions, clean-account downloaded launch, signing/notarization and production host certification are unverified. Windows is deferred; a source build is not platform certification. |
